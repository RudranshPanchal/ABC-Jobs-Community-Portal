      ...
      <div class="row">
        <div class="col-lg-4 offset-lg-2 col-md-5 offset-md-1">
          <h2 class="custom_heading">Your Profile</h2>
			    ...
			    <p> 
			        <label for="role" class="role" data-icon="I">Role</label>
			        <input readonly id="role" name="uuRole" type="text" value="${role}" />
			    </p>
			    <p> 
			    ...
			    <p> 
			        ...
			        <input readonly id="password" name="uuPassword" required="required" minlength="8" type="password" value="${password}"/>                               
			    </p>
